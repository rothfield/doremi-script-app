...
{var pred__5807 = cljs.core._EQ_;var expr__5808 = limit;if(cljs.core.truth_(pred__5807.call(null,(1),expr__5808)))
...
{var ch = s.charAt(index);var temp__4124__auto___5814 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___5814))
{var replacement_5815 = temp__4124__auto___5814;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_5815)));
} else
{buffer.append(ch);
}
{
