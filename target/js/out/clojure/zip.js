...
{var vec__6963 = loc;var node = cljs.core.nth.call(null,vec__6963,(0),null);var path = cljs.core.nth.call(null,vec__6963,(1),null);var vec__6964 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__6964,(0),null);var cnext = cljs.core.nthnext.call(null,vec__6964,(1));var cs = vec__6964;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__6967 = loc;var node = cljs.core.nth.call(null,vec__6967,(0),null);var map__6968 = cljs.core.nth.call(null,vec__6967,(1),null);var map__6968__$1 = ((cljs.core.seq_QMARK_.call(null,map__6968))?cljs.core.apply.call(null,cljs.core.hash_map,map__6968):map__6968);var path = map__6968__$1;var l = cljs.core.get.call(null,map__6968__$1,new cljs.core.Keyword(null,"l","l",1395893423));var ppath = cljs.core.get.call(null,map__6968__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));var pnodes = cljs.core.get.call(null,map__6968__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));var r = cljs.core.get.call(null,map__6968__$1,new cljs.core.Keyword(null,"r","r",-471384190));var changed_QMARK_ = cljs.core.get.call(null,map__6968__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));if(cljs.core.truth_(pnodes))
...
*/
clojure.zip.right = (function right(loc){var vec__6973 = loc;var node = cljs.core.nth.call(null,vec__6973,(0),null);var map__6974 = cljs.core.nth.call(null,vec__6973,(1),null);var map__6974__$1 = ((cljs.core.seq_QMARK_.call(null,map__6974))?cljs.core.apply.call(null,cljs.core.hash_map,map__6974):map__6974);var path = map__6974__$1;var l = cljs.core.get.call(null,map__6974__$1,new cljs.core.Keyword(null,"l","l",1395893423));var vec__6975 = cljs.core.get.call(null,map__6974__$1,new cljs.core.Keyword(null,"r","r",-471384190));var r = cljs.core.nth.call(null,vec__6975,(0),null);var rnext = cljs.core.nthnext.call(null,vec__6975,(1));var rs = vec__6975;if(cljs.core.truth_((function (){var and__3413__auto__ = path;if(cljs.core.truth_(and__3413__auto__))
{return rs;
} else
{return and__3413__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__6978 = loc;var node = cljs.core.nth.call(null,vec__6978,(0),null);var map__6979 = cljs.core.nth.call(null,vec__6978,(1),null);var map__6979__$1 = ((cljs.core.seq_QMARK_.call(null,map__6979))?cljs.core.apply.call(null,cljs.core.hash_map,map__6979):map__6979);var path = map__6979__$1;var l = cljs.core.get.call(null,map__6979__$1,new cljs.core.Keyword(null,"l","l",1395893423));var r = cljs.core.get.call(null,map__6979__$1,new cljs.core.Keyword(null,"r","r",-471384190));if(cljs.core.truth_((function (){var and__3413__auto__ = path;if(cljs.core.truth_(and__3413__auto__))
{return r;
} else
{return and__3413__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__6982 = loc;var node = cljs.core.nth.call(null,vec__6982,(0),null);var map__6983 = cljs.core.nth.call(null,vec__6982,(1),null);var map__6983__$1 = ((cljs.core.seq_QMARK_.call(null,map__6983))?cljs.core.apply.call(null,cljs.core.hash_map,map__6983):map__6983);var path = map__6983__$1;var l = cljs.core.get.call(null,map__6983__$1,new cljs.core.Keyword(null,"l","l",1395893423));var r = cljs.core.get.call(null,map__6983__$1,new cljs.core.Keyword(null,"r","r",-471384190));if(cljs.core.truth_((function (){var and__3413__auto__ = path;if(cljs.core.truth_(and__3413__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__6986 = loc;var node = cljs.core.nth.call(null,vec__6986,(0),null);var map__6987 = cljs.core.nth.call(null,vec__6986,(1),null);var map__6987__$1 = ((cljs.core.seq_QMARK_.call(null,map__6987))?cljs.core.apply.call(null,cljs.core.hash_map,map__6987):map__6987);var path = map__6987__$1;var l = cljs.core.get.call(null,map__6987__$1,new cljs.core.Keyword(null,"l","l",1395893423));var r = cljs.core.get.call(null,map__6987__$1,new cljs.core.Keyword(null,"r","r",-471384190));if(cljs.core.truth_((function (){var and__3413__auto__ = path;if(cljs.core.truth_(and__3413__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__3413__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__6990 = loc;var node = cljs.core.nth.call(null,vec__6990,(0),null);var map__6991 = cljs.core.nth.call(null,vec__6990,(1),null);var map__6991__$1 = ((cljs.core.seq_QMARK_.call(null,map__6991))?cljs.core.apply.call(null,cljs.core.hash_map,map__6991):map__6991);var path = map__6991__$1;var l = cljs.core.get.call(null,map__6991__$1,new cljs.core.Keyword(null,"l","l",1395893423));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__6994 = loc;var node = cljs.core.nth.call(null,vec__6994,(0),null);var map__6995 = cljs.core.nth.call(null,vec__6994,(1),null);var map__6995__$1 = ((cljs.core.seq_QMARK_.call(null,map__6995))?cljs.core.apply.call(null,cljs.core.hash_map,map__6995):map__6995);var path = map__6995__$1;var r = cljs.core.get.call(null,map__6995__$1,new cljs.core.Keyword(null,"r","r",-471384190));if((path == null))
{throw "Insert at top";
} else
...
*/
clojure.zip.replace = (function replace(loc,node){var vec__6997 = loc;var _ = cljs.core.nth.call(null,vec__6997,(0),null);var path = cljs.core.nth.call(null,vec__6997,(1),null);return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [node,cljs.core.assoc.call(null,path,new cljs.core.Keyword(null,"changed?","changed?",-437828330),true)], null),cljs.core.meta.call(null,loc));
});
/**
...
edit.cljs$lang$applyTo = (function (arglist__6998){
var loc = cljs.core.first(arglist__6998);
arglist__6998 = cljs.core.next(arglist__6998);
var f = cljs.core.first(arglist__6998);
...
{{
var G__6999 = clojure.zip.up.call(null,p);
p = G__6999;
continue;
}
}
...
var G__7000 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__7000;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__7003 = loc;var node = cljs.core.nth.call(null,vec__7003,(0),null);var map__7004 = cljs.core.nth.call(null,vec__7003,(1),null);var map__7004__$1 = ((cljs.core.seq_QMARK_.call(null,map__7004))?cljs.core.apply.call(null,cljs.core.hash_map,map__7004):map__7004);var path = map__7004__$1;var l = cljs.core.get.call(null,map__7004__$1,new cljs.core.Keyword(null,"l","l",1395893423));var ppath = cljs.core.get.call(null,map__7004__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));var pnodes = cljs.core.get.call(null,map__7004__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));var rs = cljs.core.get.call(null,map__7004__$1,new cljs.core.Keyword(null,"r","r",-471384190));if((path == null))
{throw "Remove at top";
} else
...
var G__7005 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__7005;
continue;
}
} else
