...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj7925 = {};return obj7925;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__3413__auto__ = this$;if(and__3413__auto__)
...
{var x__4062__auto__ = (((this$ == null))?null:this$);return (function (){var or__3425__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__4062__auto__)]);if(or__3425__auto__)
{return or__3425__auto__;
} else
{var or__3425__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__3425__auto____$1)
...
return (function (p__7926){var vec__7927 = p__7926;var k = cljs.core.nth.call(null,vec__7927,(0),null);var v = cljs.core.nth.call(null,vec__7927,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
