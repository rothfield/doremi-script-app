...
format.cljs$lang$applyTo = (function (arglist__5947){
var fmt = cljs.core.first(arglist__5947);
...
var G__5956__delegate = function (num1,num2,nums){var v = cljs.core.vec.call(null,cljs.core.map.call(null,instaparse.abnf.coerce_char,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [num1,num2], null),nums)));if(cljs.core._EQ_.call(null,v.call(null,(1)),"-"))
...
return (function iter__5952(s__5953){return (new cljs.core.LazySeq(null,((function (v){
return (function (){var s__5953__$1 = s__5953;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__5953__$1);if(temp__4126__auto__)
{var s__5953__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__5953__$2))
{var c__4162__auto__ = cljs.core.chunk_first.call(null,s__5953__$2);var size__4163__auto__ = cljs.core.count.call(null,c__4162__auto__);var b__5955 = cljs.core.chunk_buffer.call(null,size__4163__auto__);if((function (){var i__5954 = (0);while(true){
if((i__5954 < size__4163__auto__))
{var n = cljs.core._nth.call(null,c__4162__auto__,i__5954);cljs.core.chunk_append.call(null,b__5955,instaparse.combinators_source.string.call(null,cljs.core.apply.call(null,cljs.core.str,instaparse.abnf.char_codes.call(null,n))));
{
...
{var n = cljs.core.first.call(null,s__5953__$2);return cljs.core.cons.call(null,instaparse.combinators_source.string.call(null,cljs.core.apply.call(null,cljs.core.str,instaparse.abnf.char_codes.call(null,n))),iter__5952.call(null,cljs.core.rest.call(null,s__5953__$2)));
}
} else
{return null;
}
...
var G__5956 = function (num1,num2,var_args){
var nums = null;if (arguments.length > 2) {
  nums = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__5956__delegate.call(this,num1,num2,nums);};
G__5956.cljs$lang$maxFixedArity = 2;
G__5956.cljs$lang$applyTo = (function (arglist__5958){
var num1 = cljs.core.first(arglist__5958);
arglist__5958 = cljs.core.next(arglist__5958);
var num2 = cljs.core.first(arglist__5958);
var nums = cljs.core.rest(arglist__5958);
return G__5956__delegate(num1,num2,nums);
});
...
*/
instaparse.abnf.project = (function project(m,ks){return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4164__auto__ = (function iter__5963(s__5964){return (new cljs.core.LazySeq(null,(function (){var s__5964__$1 = s__5964;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__5964__$1);if(temp__4126__auto__)
{var s__5964__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__5964__$2))
{var c__4162__auto__ = cljs.core.chunk_first.call(null,s__5964__$2);var size__4163__auto__ = cljs.core.count.call(null,c__4162__auto__);var b__5966 = cljs.core.chunk_buffer.call(null,size__4163__auto__);if((function (){var i__5965 = (0);while(true){
if((i__5965 < size__4163__auto__))
{var k = cljs.core._nth.call(null,c__4162__auto__,i__5965);if(cljs.core.contains_QMARK_.call(null,m,k))
{cljs.core.chunk_append.call(null,b__5966,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,m.call(null,k)], null));
{
var G__5967 = (i__5965 + (1));
i__5965 = G__5967;
continue;
}
} else
...
{var k = cljs.core.first.call(null,s__5964__$2);if(cljs.core.contains_QMARK_.call(null,m,k))
{return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,m.call(null,k)], null),iter__5963.call(null,cljs.core.rest.call(null,s__5964__$2)));
} else
{{
var G__5969 = cljs.core.rest.call(null,s__5964__$2);
s__5964__$1 = G__5969;
continue;
}
}
...
var G__5974__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs),(2));
};
...
return G__5974__delegate.call(this,cs);};
G__5974.cljs$lang$maxFixedArity = 0;
G__5974.cljs$lang$applyTo = (function (arglist__5975){
var cs = cljs.core.seq(arglist__5975);
return G__5974__delegate(cs);
});
G__5974.cljs$core$IFn$_invoke$arity$variadic = G__5974__delegate;
return G__5974;
})()
,cljs.core.hash_map,(function() { 
var G__5976__delegate = function (rest__5971_SHARP_){if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_))
{return instaparse.combinators_source.nt.call(null,cljs.core.keyword.call(null,clojure.string.upper_case.call(null,cljs.core.apply.call(null,cljs.core.str,rest__5971_SHARP_))));
} else
{return instaparse.combinators_source.nt.call(null,cljs.core.keyword.call(null,cljs.core.apply.call(null,cljs.core.str,rest__5971_SHARP_)));
}
};
var G__5976 = function (var_args){
var rest__5971_SHARP_ = null;if (arguments.length > 0) {
  rest__5971_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__5976__delegate.call(this,rest__5971_SHARP_);};
G__5976.cljs$lang$maxFixedArity = 0;
G__5976.cljs$lang$applyTo = (function (arglist__5977){
var rest__5971_SHARP_ = cljs.core.seq(arglist__5977);
return G__5976__delegate(rest__5971_SHARP_);
});
G__5976.cljs$core$IFn$_invoke$arity$variadic = G__5976__delegate;
return G__5976;
})()
,(function() { 
var G__5978__delegate = function (rest__5972_SHARP_){return parseInt(cljs.core.apply.call(null,cljs.core.str,rest__5972_SHARP_));
};
var G__5978 = function (var_args){
var rest__5972_SHARP_ = null;if (arguments.length > 0) {
  rest__5972_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__5978__delegate.call(this,rest__5972_SHARP_);};
G__5978.cljs$lang$maxFixedArity = 0;
G__5978.cljs$lang$applyTo = (function (arglist__5979){
var rest__5972_SHARP_ = cljs.core.seq(arglist__5979);
return G__5978__delegate(rest__5972_SHARP_);
});
G__5978.cljs$core$IFn$_invoke$arity$variadic = G__5978__delegate;
return G__5978;
})()
,(function() { 
var G__5980__delegate = function (cs){return instaparse.combinators_source.string_ci.call(null,cljs.core.apply.call(null,cljs.core.str,cs));
};
var G__5980 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__5980__delegate.call(this,cs);};
G__5980.cljs$lang$maxFixedArity = 0;
G__5980.cljs$lang$applyTo = (function (arglist__5981){
var cs = cljs.core.seq(arglist__5981);
return G__5980__delegate(cs);
});
...
var G__5982__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs),(16));
};
var G__5982 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__5982__delegate.call(this,cs);};
G__5982.cljs$lang$maxFixedArity = 0;
G__5982.cljs$lang$applyTo = (function (arglist__5983){
var cs = cljs.core.seq(arglist__5983);
return G__5982__delegate(cs);
});
...
var G__5984 = null;
var G__5984__1 = (function (element){return element;
});
var G__5984__2 = (function (repeat,element){if(cljs.core.empty_QMARK_.call(null,repeat))
...
G__5984 = function(repeat,element){
switch(arguments.length){
case 1:
return G__5984__1.call(this,repeat);
case 2:
return G__5984__2.call(this,repeat,element);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__5984.cljs$core$IFn$_invoke$arity$1 = G__5984__1;
G__5984.cljs$core$IFn$_invoke$arity$2 = G__5984__2;
return G__5984;
})()
,(function() { 
var G__5985__delegate = function (rest__5970_SHARP_){if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_))
{return cljs.core.keyword.call(null,clojure.string.upper_case.call(null,cljs.core.apply.call(null,cljs.core.str,rest__5970_SHARP_)));
} else
{return cljs.core.keyword.call(null,cljs.core.apply.call(null,cljs.core.str,rest__5970_SHARP_));
}
};
var G__5985 = function (var_args){
var rest__5970_SHARP_ = null;if (arguments.length > 0) {
  rest__5970_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__5985__delegate.call(this,rest__5970_SHARP_);};
G__5985.cljs$lang$maxFixedArity = 0;
G__5985.cljs$lang$applyTo = (function (arglist__5986){
var rest__5970_SHARP_ = cljs.core.seq(arglist__5986);
return G__5985__delegate(rest__5970_SHARP_);
});
G__5985.cljs$core$IFn$_invoke$arity$variadic = G__5985__delegate;
return G__5985;
})()
,(function() { 
var G__5987__delegate = function (items){var G__5973 = cljs.core.count.call(null,items);switch (G__5973) {
case (1):
...
return G__5987__delegate.call(this,items);};
G__5987.cljs$lang$maxFixedArity = 0;
G__5987.cljs$lang$applyTo = (function (arglist__5989){
var items = cljs.core.seq(arglist__5989);
return G__5987__delegate(items);
});
G__5987.cljs$core$IFn$_invoke$arity$variadic = G__5987__delegate;
return G__5987;
})()
,instaparse.abnf.get_char_combinator,(function() { 
var G__5990__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs));
};
var G__5990 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__5990__delegate.call(this,cs);};
G__5990.cljs$lang$maxFixedArity = 0;
G__5990.cljs$lang$applyTo = (function (arglist__5991){
var cs = cljs.core.seq(arglist__5991);
return G__5990__delegate(cs);
});
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_5994_5996 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_5994_5996,sb__4366__auto__,rule_tree){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_5994_5996,sb__4366__auto__,rule_tree))
;
cljs.core.println.call(null,rule_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_5994_5996;
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_5995_5997 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_5995_5997,sb__4366__auto__,rhs_tree){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_5995_5997,sb__4366__auto__,rhs_tree))
;
cljs.core.println.call(null,rhs_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_5995_5997;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4366__auto__));
})()));
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_5999_6000 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_5999_6000,sb__4366__auto__,rule_tree){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_5999_6000,sb__4366__auto__,rule_tree))
;
cljs.core.println.call(null,rule_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_5999_6000;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4366__auto__));
})()));
} else
