...
format.cljs$lang$applyTo = (function (arglist__7393){
var fmt = cljs.core.first(arglist__7393);
...
var G__7402__delegate = function (num1,num2,nums){var v = cljs.core.vec.call(null,cljs.core.map.call(null,instaparse.abnf.coerce_char,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [num1,num2], null),nums)));if(cljs.core._EQ_.call(null,v.call(null,(1)),"-"))
...
return (function iter__7398(s__7399){return (new cljs.core.LazySeq(null,((function (v){
return (function (){var s__7399__$1 = s__7399;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__7399__$1);if(temp__4126__auto__)
{var s__7399__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__7399__$2))
{var c__4162__auto__ = cljs.core.chunk_first.call(null,s__7399__$2);var size__4163__auto__ = cljs.core.count.call(null,c__4162__auto__);var b__7401 = cljs.core.chunk_buffer.call(null,size__4163__auto__);if((function (){var i__7400 = (0);while(true){
if((i__7400 < size__4163__auto__))
{var n = cljs.core._nth.call(null,c__4162__auto__,i__7400);cljs.core.chunk_append.call(null,b__7401,instaparse.combinators_source.string.call(null,cljs.core.apply.call(null,cljs.core.str,instaparse.abnf.char_codes.call(null,n))));
{
var G__7403 = (i__7400 + (1));
i__7400 = G__7403;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7401),iter__7398.call(null,cljs.core.chunk_rest.call(null,s__7399__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7401),null);
}
} else
{var n = cljs.core.first.call(null,s__7399__$2);return cljs.core.cons.call(null,instaparse.combinators_source.string.call(null,cljs.core.apply.call(null,cljs.core.str,instaparse.abnf.char_codes.call(null,n))),iter__7398.call(null,cljs.core.rest.call(null,s__7399__$2)));
}
} else
{return null;
}
...
var G__7402 = function (num1,num2,var_args){
var nums = null;if (arguments.length > 2) {
  nums = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__7402__delegate.call(this,num1,num2,nums);};
G__7402.cljs$lang$maxFixedArity = 2;
G__7402.cljs$lang$applyTo = (function (arglist__7404){
var num1 = cljs.core.first(arglist__7404);
arglist__7404 = cljs.core.next(arglist__7404);
var num2 = cljs.core.first(arglist__7404);
var nums = cljs.core.rest(arglist__7404);
return G__7402__delegate(num1,num2,nums);
});
...
*/
instaparse.abnf.project = (function project(m,ks){return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4164__auto__ = (function iter__7409(s__7410){return (new cljs.core.LazySeq(null,(function (){var s__7410__$1 = s__7410;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__7410__$1);if(temp__4126__auto__)
{var s__7410__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__7410__$2))
{var c__4162__auto__ = cljs.core.chunk_first.call(null,s__7410__$2);var size__4163__auto__ = cljs.core.count.call(null,c__4162__auto__);var b__7412 = cljs.core.chunk_buffer.call(null,size__4163__auto__);if((function (){var i__7411 = (0);while(true){
if((i__7411 < size__4163__auto__))
{var k = cljs.core._nth.call(null,c__4162__auto__,i__7411);if(cljs.core.contains_QMARK_.call(null,m,k))
{cljs.core.chunk_append.call(null,b__7412,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,m.call(null,k)], null));
{
var G__7413 = (i__7411 + (1));
i__7411 = G__7413;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7412),iter__7409.call(null,cljs.core.chunk_rest.call(null,s__7410__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7412),null);
}
} else
{var k = cljs.core.first.call(null,s__7410__$2);if(cljs.core.contains_QMARK_.call(null,m,k))
{return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,m.call(null,k)], null),iter__7409.call(null,cljs.core.rest.call(null,s__7410__$2)));
} else
{{
var G__7415 = cljs.core.rest.call(null,s__7410__$2);
s__7410__$1 = G__7415;
continue;
}
}
...
var G__7420__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs),(2));
};
...
return G__7420__delegate.call(this,cs);};
G__7420.cljs$lang$maxFixedArity = 0;
G__7420.cljs$lang$applyTo = (function (arglist__7421){
var cs = cljs.core.seq(arglist__7421);
return G__7420__delegate(cs);
});
G__7420.cljs$core$IFn$_invoke$arity$variadic = G__7420__delegate;
return G__7420;
})()
,cljs.core.hash_map,(function() { 
var G__7422__delegate = function (rest__7417_SHARP_){if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_))
{return instaparse.combinators_source.nt.call(null,cljs.core.keyword.call(null,clojure.string.upper_case.call(null,cljs.core.apply.call(null,cljs.core.str,rest__7417_SHARP_))));
} else
{return instaparse.combinators_source.nt.call(null,cljs.core.keyword.call(null,cljs.core.apply.call(null,cljs.core.str,rest__7417_SHARP_)));
}
};
var G__7422 = function (var_args){
var rest__7417_SHARP_ = null;if (arguments.length > 0) {
  rest__7417_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__7422__delegate.call(this,rest__7417_SHARP_);};
G__7422.cljs$lang$maxFixedArity = 0;
G__7422.cljs$lang$applyTo = (function (arglist__7423){
var rest__7417_SHARP_ = cljs.core.seq(arglist__7423);
return G__7422__delegate(rest__7417_SHARP_);
});
G__7422.cljs$core$IFn$_invoke$arity$variadic = G__7422__delegate;
return G__7422;
})()
,(function() { 
var G__7424__delegate = function (rest__7418_SHARP_){return parseInt(cljs.core.apply.call(null,cljs.core.str,rest__7418_SHARP_));
};
var G__7424 = function (var_args){
var rest__7418_SHARP_ = null;if (arguments.length > 0) {
  rest__7418_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__7424__delegate.call(this,rest__7418_SHARP_);};
G__7424.cljs$lang$maxFixedArity = 0;
G__7424.cljs$lang$applyTo = (function (arglist__7425){
var rest__7418_SHARP_ = cljs.core.seq(arglist__7425);
return G__7424__delegate(rest__7418_SHARP_);
});
G__7424.cljs$core$IFn$_invoke$arity$variadic = G__7424__delegate;
return G__7424;
})()
,(function() { 
var G__7426__delegate = function (cs){return instaparse.combinators_source.string_ci.call(null,cljs.core.apply.call(null,cljs.core.str,cs));
};
...
var G__7428__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs),(16));
};
var G__7428 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__7428__delegate.call(this,cs);};
G__7428.cljs$lang$maxFixedArity = 0;
G__7428.cljs$lang$applyTo = (function (arglist__7429){
var cs = cljs.core.seq(arglist__7429);
return G__7428__delegate(cs);
});
...
var G__7430 = null;
var G__7430__1 = (function (element){return element;
});
var G__7430__2 = (function (repeat,element){if(cljs.core.empty_QMARK_.call(null,repeat))
...
G__7430 = function(repeat,element){
switch(arguments.length){
case 1:
return G__7430__1.call(this,repeat);
case 2:
return G__7430__2.call(this,repeat,element);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
,(function() { 
var G__7431__delegate = function (rest__7416_SHARP_){if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_))
{return cljs.core.keyword.call(null,clojure.string.upper_case.call(null,cljs.core.apply.call(null,cljs.core.str,rest__7416_SHARP_)));
} else
{return cljs.core.keyword.call(null,cljs.core.apply.call(null,cljs.core.str,rest__7416_SHARP_));
}
};
...
return G__7431__delegate.call(this,rest__7416_SHARP_);};
G__7431.cljs$lang$maxFixedArity = 0;
G__7431.cljs$lang$applyTo = (function (arglist__7432){
var rest__7416_SHARP_ = cljs.core.seq(arglist__7432);
return G__7431__delegate(rest__7416_SHARP_);
});
G__7431.cljs$core$IFn$_invoke$arity$variadic = G__7431__delegate;
return G__7431;
})()
,(function() { 
var G__7433__delegate = function (items){var G__7419 = cljs.core.count.call(null,items);switch (G__7419) {
case (1):
...
return G__7433__delegate.call(this,items);};
G__7433.cljs$lang$maxFixedArity = 0;
G__7433.cljs$lang$applyTo = (function (arglist__7435){
var items = cljs.core.seq(arglist__7435);
return G__7433__delegate(items);
});
G__7433.cljs$core$IFn$_invoke$arity$variadic = G__7433__delegate;
return G__7433;
})()
,instaparse.abnf.get_char_combinator,(function() { 
var G__7436__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs));
};
var G__7436 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__7436__delegate.call(this,cs);};
G__7436.cljs$lang$maxFixedArity = 0;
G__7436.cljs$lang$applyTo = (function (arglist__7437){
var cs = cljs.core.seq(arglist__7437);
return G__7436__delegate(cs);
});
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_7440_7442 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_7440_7442,sb__4366__auto__,rule_tree){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_7440_7442,sb__4366__auto__,rule_tree))
;
cljs.core.println.call(null,rule_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_7440_7442;
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_7441_7443 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_7441_7443,sb__4366__auto__,rhs_tree){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_7441_7443,sb__4366__auto__,rhs_tree))
;
cljs.core.println.call(null,rhs_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_7441_7443;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4366__auto__));
})()));
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_7445_7446 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_7445_7446,sb__4366__auto__,rule_tree){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_7445_7446,sb__4366__auto__,rule_tree))
;
cljs.core.println.call(null,rule_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_7445_7446;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4366__auto__));
})()));
} else
