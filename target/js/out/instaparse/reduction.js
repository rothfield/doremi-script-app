...
instaparse.reduction.apply_reduction = (function apply_reduction(f,result){var G__14212 = (((cljs.core.constant$keyword$38.cljs$core$IFn$_invoke$arity$1(f) instanceof cljs.core.Keyword))?cljs.core.constant$keyword$38.cljs$core$IFn$_invoke$arity$1(f).fqn:null);switch (G__14212) {
case "enlive":
...
break;
default:
var G__14213 = result;return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__14213) : f.call(null,G__14213));
...
var apply_standard_reductions__2 = (function (reduction_type,grammar){var temp__4124__auto__ = (function (){var G__14232 = reduction_type;return (instaparse.reduction.reduction_types.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.reduction_types.cljs$core$IFn$_invoke$arity$1(G__14232) : instaparse.reduction.reduction_types.call(null,G__14232));
...
return (function iter__14233(s__14234){return (new cljs.core.LazySeq(null,((function (reduction,temp__4124__auto__){
return (function (){var s__14234__$1 = s__14234;while(true){
var temp__4126__auto__ = cljs.core.seq(s__14234__$1);if(temp__4126__auto__)
{var s__14234__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_(s__14234__$2))
{var c__4162__auto__ = cljs.core.chunk_first(s__14234__$2);var size__4163__auto__ = cljs.core.count(c__4162__auto__);var b__14236 = cljs.core.chunk_buffer(size__4163__auto__);if((function (){var i__14235 = (0);while(true){
if((i__14235 < size__4163__auto__))
{var vec__14243 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4162__auto__,i__14235);var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14243,(0),null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14243,(1),null);cljs.core.chunk_append(b__14236,(cljs.core.truth_(cljs.core.constant$keyword$37.cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,cljs.core.constant$keyword$37,(function (){var G__14244 = k;return (reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(G__14244) : reduction.call(null,G__14244));
})())], null)));
{
var G__14247 = (i__14235 + (1));
i__14235 = G__14247;
continue;
}
} else
...
{return cljs.core.chunk_cons(cljs.core.chunk(b__14236),iter__14233(cljs.core.chunk_rest(s__14234__$2)));
} else
{return cljs.core.chunk_cons(cljs.core.chunk(b__14236),null);
}
} else
{var vec__14245 = cljs.core.first(s__14234__$2);var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14245,(0),null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14245,(1),null);return cljs.core.cons((cljs.core.truth_(cljs.core.constant$keyword$37.cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,cljs.core.constant$keyword$37,(function (){var G__14246 = k;return (reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(G__14246) : reduction.call(null,G__14246));
})())], null)),iter__14233(cljs.core.rest(s__14234__$2)));
}
} else
{return null;
}
