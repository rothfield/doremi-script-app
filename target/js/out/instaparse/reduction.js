...
instaparse.reduction.apply_reduction = (function apply_reduction(f,result){var G__7515 = (((new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f).fqn:null);switch (G__7515) {
case "enlive":
...
return (function iter__7525(s__7526){return (new cljs.core.LazySeq(null,((function (reduction,temp__4124__auto__){
return (function (){var s__7526__$1 = s__7526;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__7526__$1);if(temp__4126__auto__)
{var s__7526__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__7526__$2))
{var c__4162__auto__ = cljs.core.chunk_first.call(null,s__7526__$2);var size__4163__auto__ = cljs.core.count.call(null,c__4162__auto__);var b__7528 = cljs.core.chunk_buffer.call(null,size__4163__auto__);if((function (){var i__7527 = (0);while(true){
if((i__7527 < size__4163__auto__))
{var vec__7531 = cljs.core._nth.call(null,c__4162__auto__,i__7527);var k = cljs.core.nth.call(null,vec__7531,(0),null);var v = cljs.core.nth.call(null,vec__7531,(1),null);cljs.core.chunk_append.call(null,b__7528,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.call(null,v,new cljs.core.Keyword(null,"red","red",-969428204),reduction.call(null,k))], null)));
{
...
{var vec__7532 = cljs.core.first.call(null,s__7526__$2);var k = cljs.core.nth.call(null,vec__7532,(0),null);var v = cljs.core.nth.call(null,vec__7532,(1),null);return cljs.core.cons.call(null,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.call(null,v,new cljs.core.Keyword(null,"red","red",-969428204),reduction.call(null,k))], null)),iter__7525.call(null,cljs.core.rest.call(null,s__7526__$2)));
}
} else
{return null;
}
