...
instaparse.reduction.apply_reduction = (function apply_reduction(f,result){var G__13088 = (((cljs.core.constant$keyword$38.cljs$core$IFn$_invoke$arity$1(f) instanceof cljs.core.Keyword))?cljs.core.constant$keyword$38.cljs$core$IFn$_invoke$arity$1(f).fqn:null);switch (G__13088) {
case "enlive":
...
break;
default:
var G__13089 = result;return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__13089) : f.call(null,G__13089));
...
var apply_standard_reductions__2 = (function (reduction_type,grammar){var temp__4124__auto__ = (function (){var G__13108 = reduction_type;return (instaparse.reduction.reduction_types.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.reduction_types.cljs$core$IFn$_invoke$arity$1(G__13108) : instaparse.reduction.reduction_types.call(null,G__13108));
...
return (function iter__13109(s__13110){return (new cljs.core.LazySeq(null,((function (reduction,temp__4124__auto__){
return (function (){var s__13110__$1 = s__13110;while(true){
var temp__4126__auto__ = cljs.core.seq(s__13110__$1);if(temp__4126__auto__)
{var s__13110__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_(s__13110__$2))
{var c__4162__auto__ = cljs.core.chunk_first(s__13110__$2);var size__4163__auto__ = cljs.core.count(c__4162__auto__);var b__13112 = cljs.core.chunk_buffer(size__4163__auto__);if((function (){var i__13111 = (0);while(true){
if((i__13111 < size__4163__auto__))
{var vec__13119 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4162__auto__,i__13111);var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13119,(0),null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13119,(1),null);cljs.core.chunk_append(b__13112,(cljs.core.truth_(cljs.core.constant$keyword$37.cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,cljs.core.constant$keyword$37,(function (){var G__13120 = k;return (reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(G__13120) : reduction.call(null,G__13120));
})())], null)));
{
var G__13123 = (i__13111 + (1));
i__13111 = G__13123;
continue;
}
} else
...
{return cljs.core.chunk_cons(cljs.core.chunk(b__13112),iter__13109(cljs.core.chunk_rest(s__13110__$2)));
} else
{return cljs.core.chunk_cons(cljs.core.chunk(b__13112),null);
}
} else
{var vec__13121 = cljs.core.first(s__13110__$2);var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13121,(0),null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13121,(1),null);return cljs.core.cons((cljs.core.truth_(cljs.core.constant$keyword$37.cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,cljs.core.constant$keyword$37,(function (){var G__13122 = k;return (reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(G__13122) : reduction.call(null,G__13122));
})())], null)),iter__13109(cljs.core.rest(s__13110__$2)));
}
} else
{return null;
}
