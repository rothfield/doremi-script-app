...
var get_end = null;
var get_end__1 = (function (parse){var vec__7037 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__7037,(0),null);var end = cljs.core.nth.call(null,vec__7037,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
{return cljs.core.count.call(null,parse);
}
});
var get_end__2 = (function (parse,index){var vec__7038 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__7038,(0),null);var end = cljs.core.nth.call(null,vec__7038,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
...
if(parses__$1)
{var parse = cljs.core.first.call(null,parses__$1);var vec__7040 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__7040,(0),null);var end = cljs.core.nth.call(null,vec__7040,(1),null);var end__$1 = (cljs.core.truth_(end)?end:(index + cljs.core.count.call(null,parse)));if(cljs.core._EQ_.call(null,end__$1,length))
...
{{
var G__7041 = cljs.core.next.call(null,parses__$1);
parses__$1 = G__7041;
continue;
}
}
...
var repeat_parse_hiccup__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.auto_flatten_seq.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [root_tag], null));var G__7047 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__7048 = G__7047;var parse = cljs.core.nth.call(null,vec__7048,(0),null);var end = cljs.core.nth.call(null,vec__7048,(1),null);var follow_ups = cljs.core.nth.call(null,vec__7048,(2),null);var selection = vec__7048;var index__$2 = index__$1;var parses__$1 = parses;var G__7047__$1 = G__7047;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__7049 = G__7047__$1;var parse__$1 = cljs.core.nth.call(null,vec__7049,(0),null);var end__$1 = cljs.core.nth.call(null,vec__7049,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__7049,(2),null);var selection__$1 = vec__7049;if((selection__$1 == null))
...
{{
var G__7050 = cljs.core.long$.call(null,end__$1);
var G__7051 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__7052 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__7050;
parses__$1 = G__7051;
G__7047__$1 = G__7052;
continue;
...
var repeat_parse_enlive__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__7058 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__7059 = G__7058;var parse = cljs.core.nth.call(null,vec__7059,(0),null);var end = cljs.core.nth.call(null,vec__7059,(1),null);var follow_ups = cljs.core.nth.call(null,vec__7059,(2),null);var selection = vec__7059;var index__$2 = index__$1;var parses__$1 = parses;var G__7058__$1 = G__7058;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__7060 = G__7058__$1;var parse__$1 = cljs.core.nth.call(null,vec__7060,(0),null);var end__$1 = cljs.core.nth.call(null,vec__7060,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__7060,(2),null);var selection__$1 = vec__7060;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{{
var G__7061 = cljs.core.long$.call(null,end__$1);
var G__7062 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__7063 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__7061;
parses__$1 = G__7062;
G__7058__$1 = G__7063;
continue;
...
var repeat_parse_no_tag__5 = (function (grammar,initial_parser,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__7069 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__7070 = G__7069;var parse = cljs.core.nth.call(null,vec__7070,(0),null);var end = cljs.core.nth.call(null,vec__7070,(1),null);var follow_ups = cljs.core.nth.call(null,vec__7070,(2),null);var selection = vec__7070;var index__$2 = index__$1;var parses__$1 = parses;var G__7069__$1 = G__7069;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__7071 = G__7069__$1;var parse__$1 = cljs.core.nth.call(null,vec__7071,(0),null);var end__$1 = cljs.core.nth.call(null,vec__7071,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__7071,(2),null);var selection__$1 = vec__7071;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{{
var G__7072 = cljs.core.long$.call(null,end__$1);
var G__7073 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__7074 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__7072;
parses__$1 = G__7073;
G__7069__$1 = G__7074;
continue;
...
{var G__7076 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);switch (G__7076) {
case "hiccup":
