...
*/
instaparse.transform.merge_meta = (function merge_meta(obj,metamap){if((function (){var G__13077 = obj;if(G__13077)
{var bit__4089__auto__ = (G__13077.cljs$lang$protocol_mask$partition0$ & (262144));if((bit__4089__auto__) || (G__13077.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__13077.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_(cljs.core.IWithMeta,G__13077);
} else
{return false;
}
}
...
instaparse.transform.enlive_transform = (function enlive_transform(transform_map,parse_tree){var transform = (function (){var G__13079 = cljs.core.constant$keyword$42.cljs$core$IFn$_invoke$arity$1(parse_tree);return (transform_map.cljs$core$IFn$_invoke$arity$1 ? transform_map.cljs$core$IFn$_invoke$arity$1(G__13079) : transform_map.call(null,G__13079));
...
{var temp__4124__auto__ = (function (){var G__13081 = cljs.core.first(parse_tree);return (transform_map.cljs$core$IFn$_invoke$arity$1 ? transform_map.cljs$core$IFn$_invoke$arity$1(G__13081) : transform_map.call(null,G__13081));
