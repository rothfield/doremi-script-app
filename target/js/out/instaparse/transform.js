...
*/
instaparse.transform.merge_meta = (function merge_meta(obj,metamap){if((function (){var G__7513 = obj;if(G__7513)
{var bit__4089__auto__ = (G__7513.cljs$lang$protocol_mask$partition0$ & (262144));if((bit__4089__auto__) || (G__7513.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__7513.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__7513);
} else
{return false;
}
}
...
instaparse.transform.hiccup_transform = (function hiccup_transform(transform_map,parse_tree){if((cljs.core.sequential_QMARK_.call(null,parse_tree)) && (cljs.core.seq.call(null,parse_tree)))
{var temp__4124__auto__ = transform_map.call(null,cljs.core.first.call(null,parse_tree));if(cljs.core.truth_(temp__4124__auto__))
{var transform = temp__4124__auto__;return instaparse.transform.merge_meta.call(null,cljs.core.apply.call(null,transform,cljs.core.map.call(null,cljs.core.partial.call(null,hiccup_transform,transform_map),cljs.core.next.call(null,parse_tree))),cljs.core.meta.call(null,parse_tree));
} else
...
*/
instaparse.transform.transform = (function transform(transform_map,parse_tree){if(cljs.core.truth_((function (){var and__3413__auto__ = cljs.core.map_QMARK_.call(null,parse_tree);if(and__3413__auto__)
