...
instaparse.core.unhide_parser = (function unhide_parser(parser,unhide){var G__5561 = unhide;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"all","all",892129742),G__5561))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tags","tags",1771418977),G__5561))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"content","content",15833224),G__5561))
...
{if(cljs.core._EQ_.call(null,null,G__5561))
{return parser;
} else
...
var p__5562 = null;if (arguments.length > 2) {
  p__5562 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return parse__delegate.call(this,parser,text,p__5562);};
parse.cljs$lang$maxFixedArity = 2;
parse.cljs$lang$applyTo = (function (arglist__5565){
var parser = cljs.core.first(arglist__5565);
arglist__5565 = cljs.core.next(arglist__5565);
var text = cljs.core.first(arglist__5565);
var p__5562 = cljs.core.rest(arglist__5565);
return parse__delegate(parser,text,p__5562);
});
...
var parses__delegate = function (parser,text,p__5566){var map__5568 = p__5566;var map__5568__$1 = ((cljs.core.seq_QMARK_.call(null,map__5568))?cljs.core.apply.call(null,cljs.core.hash_map,map__5568):map__5568);var options = map__5568__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"unhide","unhide",-413983695))))
{} else
{throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"contains?","contains?",-1676812576,null),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.list(new cljs.core.Symbol(null,"get","get",-971253014,null),new cljs.core.Symbol(null,"options","options",1740170016,null),new cljs.core.Keyword(null,"unhide","unhide",-413983695))))))));
}
...
var p__5566 = null;if (arguments.length > 2) {
  p__5566 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return parses__delegate.call(this,parser,text,p__5566);};
parses.cljs$lang$maxFixedArity = 2;
parses.cljs$lang$applyTo = (function (arglist__5569){
var parser = cljs.core.first(arglist__5569);
arglist__5569 = cljs.core.next(arglist__5569);
var text = cljs.core.first(arglist__5569);
var p__5566 = cljs.core.rest(arglist__5569);
return parses__delegate(parser,text,p__5566);
});
...
instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4023__auto__,k5571,else__4024__auto__){var self__ = this;
var this__4023__auto____$1 = this;var G__5574 = (((k5571 instanceof cljs.core.Keyword))?k5571.fqn:null);switch (G__5574) {
case "output-format":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k5571,else__4024__auto__);
...
instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4028__auto__,k__4029__auto__,G__5570){var self__ = this;
var this__4028__auto____$1 = this;var pred__5575 = cljs.core.keyword_identical_QMARK_;var expr__5576 = k__4029__auto__;if(cljs.core.truth_(pred__5575.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__5576)))
{return (new instaparse.core.Parser(G__5570,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__5575.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__5576)))
{return (new instaparse.core.Parser(self__.grammar,G__5570,self__.output_format,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__5575.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__5576)))
{return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__5570,self__.__meta,self__.__extmap,null));
} else
{return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4029__auto__,G__5570),null));
}
}
}
});
...
instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4020__auto__,G__5570){var self__ = this;
var this__4020__auto____$1 = this;return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__5570,self__.__extmap,self__.__hash));
});
...
G__5579 = function(self__,text,key1,val1,key2,val2,key3,val3){
switch(arguments.length){
case 2:
return G__5579__2.call(this,self__,text);
case 4:
return G__5579__4.call(this,self__,text,key1,val1);
case 6:
return G__5579__6.call(this,self__,text,key1,val1,key2,val2);
case 8:
return G__5579__8.call(this,self__,text,key1,val1,key2,val2,key3,val3);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__5579.cljs$core$IFn$_invoke$arity$2 = G__5579__2;
G__5579.cljs$core$IFn$_invoke$arity$4 = G__5579__4;
G__5579.cljs$core$IFn$_invoke$arity$6 = G__5579__6;
G__5579.cljs$core$IFn$_invoke$arity$8 = G__5579__8;
return G__5579;
})()
;
instaparse.core.Parser.prototype.apply = (function (self__,args5573){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args5573)));
});
...
instaparse.core.map__GT_Parser = (function map__GT_Parser(G__5572){return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__5572),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__5572),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__5572),null,cljs.core.dissoc.call(null,G__5572,new cljs.core.Keyword(null,"grammar","grammar",1881328267),new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676))));
});
...
var parser__delegate = function (grammar_specification,p__5580){var map__5585 = p__5580;var map__5585__$1 = ((cljs.core.seq_QMARK_.call(null,map__5585))?cljs.core.apply.call(null,cljs.core.hash_map,map__5585):map__5585);var options = map__5585__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [null,null,new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481))))
{} else
...
var input_format = cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481),instaparse.core._STAR_default_input_format_STAR_);var build_parser = (function (){var G__5586 = (((input_format instanceof cljs.core.Keyword))?input_format.fqn:null);switch (G__5586) {
case "ebnf":
if(cljs.core.truth_(cljs.core.get.call(null,options,new cljs.core.Keyword(null,"string-ci","string-ci",374631805))))
{return ((function (G__5586,input_format,map__5585,map__5585__$1,options){
return (function (spec,output_format){var _STAR_case_insensitive_literals_STAR_5587 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;try{instaparse.cfg._STAR_case_insensitive_literals_STAR_ = true;
return instaparse.cfg.build_parser.call(null,spec,output_format);
}finally {instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR_5587;
}});
;})(G__5586,input_format,map__5585,map__5585__$1,options))
} else
...
{var map__5588 = temp__4124__auto__;var map__5588__$1 = ((cljs.core.seq_QMARK_.call(null,map__5588))?cljs.core.apply.call(null,cljs.core.hash_map,map__5588):map__5588);var ws_grammar = cljs.core.get.call(null,map__5588__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));var ws_start = cljs.core.get.call(null,map__5588__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));return cljs.core.assoc.call(null,built_parser,new cljs.core.Keyword(null,"grammar","grammar",1881328267),instaparse.combinators_source.auto_whitespace.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(built_parser),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(built_parser),ws_grammar,ws_start));
} else
{return built_parser;
}
};
var parser = function (grammar_specification,var_args){
var p__5580 = null;if (arguments.length > 1) {
  p__5580 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return parser__delegate.call(this,grammar_specification,p__5580);};
parser.cljs$lang$maxFixedArity = 1;
parser.cljs$lang$applyTo = (function (arglist__5590){
var grammar_specification = cljs.core.first(arglist__5590);
var p__5580 = cljs.core.rest(arglist__5590);
return parser__delegate(grammar_specification,p__5580);
});
