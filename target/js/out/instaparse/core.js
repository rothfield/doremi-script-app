...
instaparse.core.unhide_parser = (function unhide_parser(parser,unhide){var G__13220 = unhide;if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$149,G__13220))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$150,G__13220))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$43,G__13220))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__13220))
{return parser;
} else
...
{var result = instaparse.repeat.try_repeating_parse_strategy(parser__$1,text,start_production);if(cljs.core.truth_((function (){var G__13227 = result;return (instaparse.core.failure_QMARK_.cljs$core$IFn$_invoke$arity$1 ? instaparse.core.failure_QMARK_.cljs$core$IFn$_invoke$arity$1(G__13227) : instaparse.core.failure_QMARK_.call(null,G__13227));
})()))
...
var p__13221 = null;if (arguments.length > 2) {
  p__13221 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return parse__delegate.call(this,parser,text,p__13221);};
parse.cljs$lang$maxFixedArity = 2;
parse.cljs$lang$applyTo = (function (arglist__13228){
var parser = cljs.core.first(arglist__13228);
arglist__13228 = cljs.core.next(arglist__13228);
var text = cljs.core.first(arglist__13228);
var p__13221 = cljs.core.rest(arglist__13228);
return parse__delegate(parser,text,p__13221);
});
...
var parses__delegate = function (parser,text,p__13229){var map__13232 = p__13229;var map__13232__$1 = ((cljs.core.seq_QMARK_(map__13232))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13232):map__13232);var options = map__13232__$1;var start_production = cljs.core.get.cljs$core$IFn$_invoke$arity$3(options,cljs.core.constant$keyword$151,cljs.core.constant$keyword$67.cljs$core$IFn$_invoke$arity$1(parser));var partial_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(options,cljs.core.constant$keyword$152,false);var unhide = cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,cljs.core.constant$keyword$153);var parser__$1 = instaparse.core.unhide_parser(parser,unhide);if(cljs.core.truth_(cljs.core.constant$keyword$154.cljs$core$IFn$_invoke$arity$1(options)))
{return instaparse.gll.parses_total(cljs.core.constant$keyword$66.cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__13233 = cljs.core.constant$keyword$110.cljs$core$IFn$_invoke$arity$1(parser__$1);return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__13233) : instaparse.reduction.node_builders.call(null,G__13233));
})());
} else
...
var p__13229 = null;if (arguments.length > 2) {
  p__13229 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return parses__delegate.call(this,parser,text,p__13229);};
parses.cljs$lang$maxFixedArity = 2;
parses.cljs$lang$applyTo = (function (arglist__13234){
var parser = cljs.core.first(arglist__13234);
arglist__13234 = cljs.core.next(arglist__13234);
var text = cljs.core.first(arglist__13234);
var p__13229 = cljs.core.rest(arglist__13234);
return parses__delegate(parser,text,p__13229);
});
...
instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4023__auto__,k13236,else__4024__auto__){var self__ = this;
var this__4023__auto____$1 = this;var G__13239 = (((k13236 instanceof cljs.core.Keyword))?k13236.fqn:null);switch (G__13239) {
case "output-format":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k13236,else__4024__auto__);
...
instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4028__auto__,k__4029__auto__,G__13235){var self__ = this;
var this__4028__auto____$1 = this;var pred__13240 = cljs.core.keyword_identical_QMARK_;var expr__13241 = k__4029__auto__;if(cljs.core.truth_((function (){var G__13243 = cljs.core.constant$keyword$66;var G__13244 = expr__13241;return (pred__13240.cljs$core$IFn$_invoke$arity$2 ? pred__13240.cljs$core$IFn$_invoke$arity$2(G__13243,G__13244) : pred__13240.call(null,G__13243,G__13244));
})()))
{return (new instaparse.core.Parser(G__13235,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_((function (){var G__13245 = cljs.core.constant$keyword$67;var G__13246 = expr__13241;return (pred__13240.cljs$core$IFn$_invoke$arity$2 ? pred__13240.cljs$core$IFn$_invoke$arity$2(G__13245,G__13246) : pred__13240.call(null,G__13245,G__13246));
})()))
{return (new instaparse.core.Parser(self__.grammar,G__13235,self__.output_format,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_((function (){var G__13247 = cljs.core.constant$keyword$110;var G__13248 = expr__13241;return (pred__13240.cljs$core$IFn$_invoke$arity$2 ? pred__13240.cljs$core$IFn$_invoke$arity$2(G__13247,G__13248) : pred__13240.call(null,G__13247,G__13248));
})()))
{return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__13235,self__.__meta,self__.__extmap,null));
} else
{return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4029__auto__,G__13235),null));
}
}
}
});
...
instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4020__auto__,G__13235){var self__ = this;
var this__4020__auto____$1 = this;return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__13235,self__.__extmap,self__.__hash));
});
...
var G__13250 = null;
var G__13250__2 = (function (self__,text){var self__ = this;
var self____$1 = this;var parser = self____$1;return instaparse.core.parse(parser,text);
});
var G__13250__4 = (function (self__,text,key1,val1){var self__ = this;
...
var G__13250__6 = (function (self__,text,key1,val1,key2,val2){var self__ = this;
...
var G__13250__8 = (function (self__,text,key1,val1,key2,val2,key3,val3){var self__ = this;
...
G__13250 = function(self__,text,key1,val1,key2,val2,key3,val3){
switch(arguments.length){
case 2:
return G__13250__2.call(this,self__,text);
case 4:
return G__13250__4.call(this,self__,text,key1,val1);
case 6:
return G__13250__6.call(this,self__,text,key1,val1,key2,val2);
case 8:
return G__13250__8.call(this,self__,text,key1,val1,key2,val2,key3,val3);
}
...
;
instaparse.core.Parser.prototype.apply = (function (self__,args13238){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args13238)));
});
...
instaparse.core.map__GT_Parser = (function map__GT_Parser(G__13237){return (new instaparse.core.Parser(cljs.core.constant$keyword$66.cljs$core$IFn$_invoke$arity$1(G__13237),cljs.core.constant$keyword$67.cljs$core$IFn$_invoke$arity$1(G__13237),cljs.core.constant$keyword$110.cljs$core$IFn$_invoke$arity$1(G__13237),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__13237,cljs.core.constant$keyword$66,cljs.core.array_seq([cljs.core.constant$keyword$67,cljs.core.constant$keyword$110], 0))));
});
...
var parser__delegate = function (grammar_specification,p__13251){var map__13259 = p__13251;var map__13259__$1 = ((cljs.core.seq_QMARK_(map__13259))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13259):map__13259);var options = map__13259__$1;var input_format = cljs.core.get.cljs$core$IFn$_invoke$arity$3(options,cljs.core.constant$keyword$155,instaparse.core._STAR_default_input_format_STAR_);var build_parser = (function (){var G__13260 = (((input_format instanceof cljs.core.Keyword))?input_format.fqn:null);switch (G__13260) {
case "ebnf":
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,cljs.core.constant$keyword$59)))
{return ((function (G__13260,input_format,map__13259,map__13259__$1,options){
return (function (spec,output_format){var _STAR_case_insensitive_literals_STAR_13261 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;try{instaparse.cfg._STAR_case_insensitive_literals_STAR_ = true;
return instaparse.cfg.build_parser(spec,output_format);
}finally {instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR_13261;
}});
;})(G__13260,input_format,map__13259,map__13259__$1,options))
} else
...
})():((cljs.core.vector_QMARK_(grammar_specification))?(function (){var start__$1 = (cljs.core.truth_(start)?start:(function (){var G__13264 = (0);return (grammar_specification.cljs$core$IFn$_invoke$arity$1 ? grammar_specification.cljs$core$IFn$_invoke$arity$1(G__13264) : grammar_specification.call(null,G__13264));
...
{var map__13265 = temp__4124__auto__;var map__13265__$1 = ((cljs.core.seq_QMARK_(map__13265))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13265):map__13265);var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13265__$1,cljs.core.constant$keyword$66);var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13265__$1,cljs.core.constant$keyword$67);return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(built_parser,cljs.core.constant$keyword$66,instaparse.combinators_source.auto_whitespace(cljs.core.constant$keyword$66.cljs$core$IFn$_invoke$arity$1(built_parser),cljs.core.constant$keyword$67.cljs$core$IFn$_invoke$arity$1(built_parser),ws_grammar,ws_start));
} else
{return built_parser;
}
};
var parser = function (grammar_specification,var_args){
var p__13251 = null;if (arguments.length > 1) {
  p__13251 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return parser__delegate.call(this,grammar_specification,p__13251);};
parser.cljs$lang$maxFixedArity = 1;
parser.cljs$lang$applyTo = (function (arglist__13267){
var grammar_specification = cljs.core.first(arglist__13267);
var p__13251 = cljs.core.rest(arglist__13267);
return parser__delegate(grammar_specification,p__13251);
});
