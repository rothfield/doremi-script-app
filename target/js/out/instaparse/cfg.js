...
{var c = temp__4124__auto__;var G__6002 = c;switch (G__6002) {
case "\\":
...
{{
var G__6004 = cljs.core.drop.call(null,(2),sq);
var G__6005 = cljs.core.conj.call(null,v,c2);
sq = G__6004;
v = G__6005;
continue;
}
...
{{
var G__6006 = cljs.core.drop.call(null,(2),sq);
var G__6007 = cljs.core.conj.call(null,v,c,c2);
sq = G__6006;
v = G__6007;
continue;
}
...
case "\"":
{
var G__6008 = cljs.core.next.call(null,sq);
var G__6009 = cljs.core.conj.call(null,v,"\\","\"");
sq = G__6008;
v = G__6009;
continue;
}
...
default:
{
var G__6010 = cljs.core.next.call(null,sq);
var G__6011 = cljs.core.conj.call(null,v,c);
sq = G__6010;
v = G__6011;
continue;
}
...
var G__6014 = (((instaparse.cfg.tag.call(null,tree) instanceof cljs.core.Keyword))?instaparse.cfg.tag.call(null,tree).fqn:null);switch (G__6014) {
case "neg":
...
break;
case "rule":
var vec__6015 = instaparse.cfg.contents.call(null,tree);var nt = cljs.core.nth.call(null,vec__6015,(0),null);var alt_or_ord = cljs.core.nth.call(null,vec__6015,(1),null);if(cljs.core._EQ_.call(null,instaparse.cfg.tag.call(null,nt),new cljs.core.Keyword(null,"hide-nt","hide-nt",-228813845)))
...
case "paren":
{
var G__6017 = instaparse.cfg.content.call(null,tree);
tree = G__6017;
continue;
}
...
var G__6019 = (((new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser).fqn:null);switch (G__6019) {
case "neg":
{
var G__6021 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__6021;
continue;
}
...
case "look":
{
var G__6022 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__6022;
continue;
}
...
case "rep":
{
var G__6023 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__6023;
continue;
}
...
case "star":
{
var G__6024 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__6024;
continue;
}
...
case "plus":
{
var G__6025 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__6025;
continue;
}
...
case "opt":
{
var G__6026 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__6026;
continue;
}
...
*/
instaparse.cfg.check_grammar = (function check_grammar(grammar_map){var valid_nts_6035 = cljs.core.set.call(null,cljs.core.keys.call(null,grammar_map));var seq__6031_6036 = cljs.core.seq.call(null,cljs.core.distinct.call(null,cljs.core.mapcat.call(null,instaparse.cfg.seq_nt,cljs.core.vals.call(null,grammar_map))));var chunk__6032_6037 = null;var count__6033_6038 = (0);var i__6034_6039 = (0);while(true){
if((i__6034_6039 < count__6033_6038))
{var nt_6040 = cljs.core._nth.call(null,chunk__6032_6037,i__6034_6039);if(cljs.core.truth_(valid_nts_6035.call(null,nt_6040)))
{} else
{throw (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_6040)),(1)))+"occurs on the right-hand side of your grammar, but not on the left");
}
{
var G__6041 = seq__6031_6036;
var G__6042 = chunk__6032_6037;
var G__6043 = count__6033_6038;
var G__6044 = (i__6034_6039 + (1));
seq__6031_6036 = G__6041;
chunk__6032_6037 = G__6042;
count__6033_6038 = G__6043;
i__6034_6039 = G__6044;
continue;
}
} else
{var temp__4126__auto___6045 = cljs.core.seq.call(null,seq__6031_6036);if(temp__4126__auto___6045)
{var seq__6031_6046__$1 = temp__4126__auto___6045;if(cljs.core.chunked_seq_QMARK_.call(null,seq__6031_6046__$1))
{var c__4195__auto___6047 = cljs.core.chunk_first.call(null,seq__6031_6046__$1);{
var G__6048 = cljs.core.chunk_rest.call(null,seq__6031_6046__$1);
var G__6049 = c__4195__auto___6047;
var G__6050 = cljs.core.count.call(null,c__4195__auto___6047);
var G__6051 = (0);
seq__6031_6036 = G__6048;
chunk__6032_6037 = G__6049;
count__6033_6038 = G__6050;
i__6034_6039 = G__6051;
continue;
}
} else
{var nt_6052 = cljs.core.first.call(null,seq__6031_6046__$1);if(cljs.core.truth_(valid_nts_6035.call(null,nt_6052)))
{} else
{throw (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_6052)),(1)))+"occurs on the right-hand side of your grammar, but not on the left");
}
{
var G__6053 = cljs.core.next.call(null,seq__6031_6046__$1);
var G__6054 = null;
var G__6055 = (0);
var G__6056 = (0);
seq__6031_6036 = G__6053;
chunk__6032_6037 = G__6054;
count__6033_6038 = G__6055;
i__6034_6039 = G__6056;
continue;
}
}
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_6058_6059 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_6058_6059,sb__4366__auto__,rules){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_6058_6059,sb__4366__auto__,rules))
;
cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_6058_6059;
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_6062_6064 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_6062_6064,sb__4366__auto__,rules){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_6062_6064,sb__4366__auto__,rules))
;
cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_6062_6064;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4366__auto__));
})()));
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4366__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_6063_6065 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_6063_6065,sb__4366__auto__,rhs){
return (function (x__4367__auto__){return sb__4366__auto__.append(x__4367__auto__);
});})(_STAR_print_fn_STAR_6063_6065,sb__4366__auto__,rhs))
;
cljs.core.println.call(null,rhs);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_6063_6065;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4366__auto__));
})()));
} else
