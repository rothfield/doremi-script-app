...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
adzerk.boot_reload.websocket.IWebSocket = (function (){var obj6961 = {};return obj6961;
})();
adzerk.boot_reload.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__3413__auto__ = this$;if(and__3413__auto__)
...
{var x__4062__auto__ = (((this$ == null))?null:this$);return (function (){var or__3425__auto__ = (adzerk.boot_reload.websocket.open_QMARK_[goog.typeOf(x__4062__auto__)]);if(or__3425__auto__)
{return or__3425__auto__;
} else
{var or__3425__auto____$1 = (adzerk.boot_reload.websocket.open_QMARK_["_"]);if(or__3425__auto____$1)
...
return (function (p__6962){var vec__6963 = p__6962;var k = cljs.core.nth.call(null,vec__6963,(0),null);var v = cljs.core.nth.call(null,vec__6963,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
